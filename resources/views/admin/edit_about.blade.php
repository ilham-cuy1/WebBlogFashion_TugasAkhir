                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('about.update', $abouts->id) }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title', $abouts->title) }}" placeholder="Masukkan Judul">
                                            ...
                                            <div class="form-group">
                                                <label class="font-weight-bold mb-2">SUB TITLE</label>
                                                <input type="text" class="form-control @error('sub_title') is-invalid @enderror" name="sub_title" value="{{ old('sub_title', $abouts->sub_title) }}" placeholder="Masukkan Sub Title">
                                                <!-- error message untuk title -->
                                                @error('sub_title')
                                                <div class="alert alert-danger mt-2">
                                                    {{ $message }}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control @error('content') is-invalid @enderror" id="content" name="content" rows="5" placeholder="Masukkan Konten Post">{{ old('content', $abouts->content) }}</textarea>
                                            ...
                                            <a href="/admin/about" class="btn btn-md btn-light">BATAL</a>
                                        </form>
                                    </div>
                                </div>
                            </div>
