                                    ...
                                    <div class="card border-0 rounded">
                                        <div class="card-body px-3 py-4-5">
                                            ...
                                            <div class="card mb-3 border text-black">
                                                <img src="{{ asset('storage/posts/'.$abouts->image) }}" class="card-img-top" alt="image" style="max-height: 65vh;">
                                                <div class="card-body">
                                                    <h2>{{ $abouts->title }}</h2>
                                                    <p class="fs-5 mb-3 mt-4 fw-bold">Sub Title :</p>
                                                    <h5>{{ $abouts->sub_title }}</h5>
                                                    <p class="fs-5 mb-3 mt-4 fw-bold">Content :</p>
                                                    <p class="card-text text-black">{!! $abouts->content !!}</p>
                                                </div>
                                            </div>
                                            <a href="/admin/about" class="btn btn-dark"><i class="fa-solid fa-arrow-left me-2" style="color: #ffffff;"></i> Back</a>
