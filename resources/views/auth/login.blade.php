...
<head>
    ...
    <title>Login - ADM AlbarStyle</title>
                ...
                <div id="auth-left">
                    ...
                    <form action="/admin/login-proses" method="POST">
                        ...
                        <div class="form-group position-relative has-icon-left ">
                            <input type="email" name="email" value="{{ Session::get('email') }}" class="form-control form-control-xl mb-2" placeholder="Email">
                        ...
                        @enderror
                        <div class="form-group position-relative has-icon-left ">
                            <input type="password" name="password" class="form-control form-control-xl mt-4" placeholder="Password">
                            <div class="form-control-icon">
